...
namespace AppSound
{
    public partial class ArmedForces : Form
    {
        ...
        public void Init()
        {
            fcmb.GetTagneedAreas(new DummyCombo { Text = "جيوش", Value = 3 }, tgneedDrp);
        ...
        public void BindToObservablesExaminerseport()
        {
            ...
            if (exsDrp != null && lpsDrp != null && dates != null)
            {
                ...
                var spQuery = (lpsDrp.Value == 1) ? "sp_Ncd_armed" : "sp_dwm_armed";
                ...
                if (drpType.Value == 1)
                {
                    ...
                    {
                       sstr = _str; dts = _list;
                       reportViewer2.LocalReport.ReportEmbeddedResource = "AppSound.Reports.Armed.rdlc";
                    });
                }
                else
                {
